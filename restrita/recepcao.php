...
<head>
    ...
    <?php
        ...
        $strQueryLog = "INSERT INTO LOGACESSO (MAQUINA, DATAHORA, PAGINA) VALUES ('$hostname', SYSDATE(), 'RECEPCAO CONSULTAR CLIENTES');";
...
<body>
    ...
    <div class="box">
        <a href="recepcaoagend.php"><button name="voltar" class="botoes btn-fechar btn-vd">Agenda</button></a>
        ...
        <form action="" method="get" class="form family">
            <h2 class="family-head">Buscar Cliente</h2>
